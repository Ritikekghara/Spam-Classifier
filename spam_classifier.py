...
Original file is located at
    https://colab.research.google.com/drive/1tOWgQ1yu-9XiVPyjgXG5fzvcXKMttz13
"""
...
def transform_text(text):
    ...
    # Clear text list and add filtered words
    text = y[:]
    y.clear()
    ...
    # Clear text list and add stemmed words
    text = y[:]
    y.clear()
